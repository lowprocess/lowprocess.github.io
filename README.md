...
- Spectrum analyser design - Currently scoping and doing feasibility analysis for design blocks. (2026)
...
- SAR ADC - Currently developing simulation for digital control logic for charge pump DAC. (Active)
